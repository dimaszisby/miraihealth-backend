...
- Detailed references:
  - `docs/how-to/security/README.md`
...
12. For production release PRs, follow `docs/how-to/security/release-delta-sop.md` and update the active security audit run docs.
