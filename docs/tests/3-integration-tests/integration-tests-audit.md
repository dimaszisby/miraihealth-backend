...
- **Documentation cross-referenced:** `docs/ci-cd/backend/**`, `docs/tests/test-classification-2025-12-22.md`, `docs/tests/overhaul/phase2-integration-coverage.md`, `.env.test`.
...
- Phase 2 repository coverage tracker (`docs/tests/overhaul/phase2-integration-coverage.md`) shows all planned repo suites marked ✅.
- `docs/tests/test-classification-2025-12-22.md` updated to reflect the current state and highlight remaining higher-order gaps (journeys, Redis).
...
- README updated with audited facts (commands, layout, environment): `docs/tests/3-integration-tests/README.md`.
- Plan/checklist/ticket capture the roadmap derived from this audit:  
  `docs/tests/3-integration-tests/integration-tests-plan.md`, `integration-tests-checklist.md`, `integration-tests-ticket.md`.
- ADRs logged to record infra decisions: `docs/tests/3-integration-tests/decisions.md`.
- Metrics tracker seeded with placeholders awaiting runtime/coverage numbers: `docs/tests/3-integration-tests/metrics-tracker.md`.
