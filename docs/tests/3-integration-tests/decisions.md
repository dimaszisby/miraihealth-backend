...
- **References:** `docs/tests/3-integration-tests/README.md`, `.github/workflows/backend-ci.yml`, `scripts/test-ci.sh`, `docker-compose.yml`, `docker-compose.test.yml`.
...
- **References:** `jest.setup.ts`, `__tests__/integration/helpers/db-fixtures.ts`, `docs/tests/3-integration-tests/README.md`.
...
- **References:** `src/config/zodEnv.ts`, `src/utils/redis-client.ts`, `.env.test.example`, `docs/tests/3-integration-tests/README.md`, `integration-tests-checklist.md`.
...
- **References:** `src/features/metric-log/application/use-cases/CreateMetricLog.ts`, `src/features/metric-log/application/use-cases/UpdateMetricLog.ts`, `__tests__/integration/api/metric-log.test.ts`, `docs/tests/3-integration-tests/checklist.md`.
...
- **References:** `jest.config.mjs`, `docs/tests/3-integration-tests/README.md`, `integration-tests-plan.md`, `integration-tests-checklist.md`.
...
- **References:** `docs/tests/3-integration-tests/README.md`, `integration-tests-plan.md` (“Open Questions”), `integration-tests-checklist.md`, `metrics-tracker.md`.
...
- **References:** `__tests__/integration/helpers/db-fixtures.ts`, `__tests__/integration/features/analytics/**`, `docs/tests/3-integration-tests/README.md`, `integration-tests-plan.md`.
...
- **References:** `jest.setup.ts`, `__tests__/integration/helpers/db-fixtures.ts`, `docs/tests/3-integration-tests/integration-tests-plan.md`, `docs/tests/3-integration-tests/metrics-tracker.md`.
