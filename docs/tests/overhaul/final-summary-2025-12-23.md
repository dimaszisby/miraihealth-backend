...
- ✅ Phase 0–4 checklist completed in `docs/tests/overhaul/test-structure-checklist.md`.
- Unit vs. integration suites fully split (`__tests__/unit/**`, `__tests__/integration/**`).
- Repository-level integration coverage now includes metrics (read/write/settings/logs), auth, analytics (visualizations), with status tracked in `docs/tests/overhaul/phase2-integration-coverage.md`.
...
| Document                                       | Highlights                                                                                         |
| ---------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| `docs/tests/test-classification-2025-12-22.md` | Lists 27 unit suites + 13 integration suites, including new repo targets.                          |
| `docs/tests/2-unit-tests/README.md`            | Describes layout, commands (`test:unit`, `test:unit:coverage`), expectations.                      |
| `docs/tests/3-integration-tests/README.md`     | Mirrors integration layout, prerequisites, coverage command, helper notes.                         |
| `docs/ci-cd/backend/*.md`                      | Updated plan/checklist/guidelines to reflect new scripts, coverage uploads, and artifact handling. |
| `docs/tests/overhaul/test-structure-plan.md`   | Tracks decisions + lessons; references final-state docs.                                           |
