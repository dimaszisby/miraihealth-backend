...
3. **Documentation updates**
   - After each suite lands, update this tracker, `docs/tests/test-classification-2025-12-22.md`, and Phase 2 entries in `test-structure-checklist.md`.
   - Note any new helpers or prerequisites in `docs/tests/3-integration-tests/README.md`.
