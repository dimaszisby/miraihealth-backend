...
Per `.claude/rules/documentation.md`, architectural topics live under `docs/development/architecture/<topic>/` as a lean kit. Use:

```
docs/development/architecture/saas-readiness/
...
- Do NOT compact or reformat anything under `docs/security/audit/` (schema-validated by tests).
