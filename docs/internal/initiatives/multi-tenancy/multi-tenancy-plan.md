...
1. ADR-004 in `docs/internal/audits/saas-readiness/decisions.md` flips Proposed → Accepted by the user. This kit's `decisions.md` ADRs (FK cascade, role enum location, invite-token format) are reviewed.
