...
This is the largest single phase in the SaaS-readiness remediation. It is gated by `ADR-004` in `docs/internal/audits/saas-readiness/decisions.md` flipping from **Proposed → Accepted**.
