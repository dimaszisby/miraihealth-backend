...
- **Closes audit gaps:** [P0-X.Y], [P1-A.B] in `docs/internal/audits/saas-readiness/audit-2026-05-01.md`
- **Owning ADRs:** ADR-NNN in `docs/internal/audits/saas-readiness/decisions.md`; (kit-local) ADR-001 in `./decisions.md`
- **Effort:** S/M/L
