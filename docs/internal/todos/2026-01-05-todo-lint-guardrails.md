...
- [ ] Record lint runtime/observations in `docs/internal/initiatives/tests-1-static-checks/metrics-tracker.md` (and any relevant ticket/checklist files) to preserve evidence for portfolio reviews.
