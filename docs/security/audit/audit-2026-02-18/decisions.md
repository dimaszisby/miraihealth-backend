...
- Links: `docs/security/framework/`, `scripts/security/`, `docs/security/templates/audit-run/`
...
- Links: `docs/security/framework/ci-gate-policy.json`, `scripts/security/evaluate-gate.mjs`, `.github/workflows/backend-ci.yml`
...
- Related finding IDs: SEC-20260218-001
- Links: `docs/security/audit/audit-2026-02-18/remediation-plan.md`, `tmp/security/security-gate-result.json`
