...
2. If temporary acceptance is required, follow `docs/security/framework/security-exceptions-policy.md` and document in run-level `decisions.md`.

## Required Documentation Updates

For each release delta check, update the active run in `docs/security/audit/`:
