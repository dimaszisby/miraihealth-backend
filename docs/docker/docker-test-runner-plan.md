...
- [x] Document the Docker workflow in `docs/docker/postgres-docker-guide.md`, highlighting teardown expectations and how to troubleshoot Compose errors like “The Compose app is no longer running.”
