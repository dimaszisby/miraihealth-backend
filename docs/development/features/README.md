...
- Feature persistence docs must explain how their Sequelize models plug into the shared bootstrap described in `docs/development/architecture/orm-bootstrap.md`.
...
- [ ] Link to architecture plan (`docs/development/architecture/feature-vertical-slice-migration/plans/feature-vertical-slice-migration-plan.md`).
