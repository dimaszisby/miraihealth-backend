...
This is the master roadmap for closing the 18 ❌ + 21 ⚠️ items in the audit. Each phase below has its own kit (or extends an existing kit) under `docs/development/architecture/`. P2-only items are deferred and not yet scaffolded.
...
- **Closes audit gaps:** [P0-X.Y], [P1-A.B] in `docs/development/architecture/saas-readiness/audit-2026-05-01.md`
- **Owning ADRs:** ADR-NNN in `docs/development/architecture/saas-readiness/decisions.md`; (kit-local) ADR-001 in `./decisions.md`
- **Effort:** S/M/L
