...
- Plan: `docs/development/architecture/indexing/postgres-indexing-plan.md`
- Checklist/evidence: `docs/development/architecture/indexing/postgres-indexing-checklist.md`
- Review/baseline: `docs/development/architecture/indexing/postgres-indexing-review.md`
