...
**Source review:** `docs/development/architecture/indexing/postgres-indexing-review.md`
...
- Review findings: `docs/development/architecture/indexing/postgres-indexing-review.md`
- Checklist/runbook: `docs/development/architecture/indexing/postgres-indexing-checklist.md`
