...
2. Add feature README template under `docs/development/features/` describing required folders/tests.
...
- **Risk**: Developer confusion about file locations.
  - _Mitigation_: provide a reference diagram and README per feature, keep documents updated in `docs/development/features/`.
...
- Surface blockers/incidents in `docs/incidents` when migrations affect production.
