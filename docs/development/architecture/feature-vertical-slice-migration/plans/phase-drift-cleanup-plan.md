...
- Closes audit gaps: [P1] 10.1, [P1] 10.2, [P2] 10.4, [P2] 10.5 in `docs/development/architecture/saas-readiness/audit-2026-05-01.md`
- Gated by: ADR-003 in `docs/development/architecture/saas-readiness/decisions.md` (canonical DDD layout — must be Accepted before work starts)
...
Note: [P1] 10.3 (auth middleware reimplements `jwt.verify`) is addressed in the JWT kit (`docs/development/architecture/jwt/`) Phase D, not here.
...
- `docs/development/architecture/saas-readiness/audit-2026-05-01.md` § 10.1–10.5
- `.claude/rules/architecture.md` — canonical layout definition
- `docs/development/architecture/saas-readiness/decisions.md` ADR-003 (canonical DDD layout)
- `docs/development/architecture/feature-vertical-slice-migration/plans/feature-vertical-slice-migration-plan.md` — original migration plan (Phases 1–4)
