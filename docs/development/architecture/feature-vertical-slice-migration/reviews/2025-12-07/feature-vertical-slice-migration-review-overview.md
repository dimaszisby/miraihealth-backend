...
| -------------------------------------------------------------------- | -------------------------------------- | ------------------------ | ------------------------------------------------------------------------------------- |
| `feature-vertical-slice-migration-in-depth-review.md`                | Finding-level audit of every feature   | Codex reviewer           | `docs/development/architecture/feature-vertical-slice-migration/reviews/2025-12-07/…` |
...
- **Output:**
  - `docs/development/architecture/feature-vertical-slice-migration/reviews/2025-12-07/feature-vertical-slice-migration-in-depth-review.md`
- **Required structure:**
...
- **Output:**
  - `docs/development/architecture/feature-vertical-slice-migration/reviews/2025-12-07/feature-vertical-slice-migration-stabilize-feature-pattern-plan.md`
- **Required structure:**
...
- **Output:**
  - Either:
    - `docs/development/architecture/feature-vertical-slice-migration/reviews/2025-12-07/feature-vertical-slice-migration-gold-review.md`, or
