...
Cross-kit ADR-003 (the canonical DDD layout standard that governs this migration) lives in `docs/development/architecture/saas-readiness/decisions.md` and gates the drift-cleanup phase documented here.
...
- `docs/development/architecture/saas-readiness/audit-2026-05-01.md` § 10.1
...
- `docs/development/architecture/saas-readiness/audit-2026-05-01.md` § 10.1 (drift #4)
