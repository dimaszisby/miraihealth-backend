...
> - `docs/development/architecture/feature-vertical-slice-migration/**` (test overhaul plan/checklist if present)
...
>    - `docs/tests/test-classification-2025-12-22.md`
...
>    - `docs/tests/test-structure-move-plan-2025-12-22.md`
...
>    - `docs/tests/test-tooling-recommendations-2025-12-22.md`
> 3. In that doc:
...
>
> Please create under `docs/tests/overhaul/` (create the folder if needed):
>
> 1. `docs/tests/overhaul/test-structure-plan.md`
...
> 2. `docs/tests/overhaul/test-structure-checklist.md`
...
>      - `[ ] Update docs/tests/2-unit-tests/README.md to mention new layout`
> 3. `docs/tests/overhaul/test-structure-ticket.md`
