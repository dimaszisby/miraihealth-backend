...
- **Location (current):**
  - `docs/tests/4-contract-tests/postman-newman/**`
...
- **Contract tests**
  - Remain in `docs/tests/4-contract-tests/postman-newman/**`.
...
```jsonc
{
  "scripts": {
    ...
    "test:contract:local": "node docs/tests/4-contract-tests/postman-newman/scripts/run-contract-local.js",
    "test:contract:staging": "node docs/tests/4-contract-tests/postman-newman/scripts/run-contract-staging.js",
  },
}
```
...
- Update `docs/tests/2-unit-tests/*` and `docs/tests/3-integration-tests/*` to:
