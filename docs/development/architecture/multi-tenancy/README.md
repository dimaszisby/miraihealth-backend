...
This is the largest single phase in the SaaS-readiness remediation. It is gated by `ADR-004` in `docs/development/architecture/saas-readiness/decisions.md` flipping from **Proposed → Accepted**.
...
- **Closes audit gaps:** [P0-3.1] (no multi-tenancy primitives in DB), [P0-9.1] (same gap as 3.1, listed under SaaS-specific category), [P1-1.3] (RBAC stub, replaced by membership.role) in `docs/development/architecture/saas-readiness/audit-2026-05-01.md`.
- **Owning ADRs:** ADR-004 in `docs/development/architecture/saas-readiness/decisions.md` MUST be Accepted before kickoff.
