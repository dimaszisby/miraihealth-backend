...
ADR-style entries scoped to the multi-tenancy kit. The cross-kit ADR-004 (the choice to introduce Organization + Membership at all) lives in `docs/development/architecture/saas-readiness/decisions.md` and gates this kit.
...
- `docs/development/features/password-reset/` (reference pattern).
