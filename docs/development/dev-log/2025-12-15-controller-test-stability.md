...
- Keep `docs/todos/` for scratch notes, but archive lasting findings (like this validation helper change) into `docs/development/dev-log/` to aid future debugging.
