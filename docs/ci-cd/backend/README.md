...
For high-level project-wide strategy, see `docs/ci-cd/CI_CD_STRATEGY.md`.

For migrated non-blocking CI/contract follow-ups, see `docs/ci-cd/backend/FOLLOW_UP_BACKLOG.md`.
...
See `docs/ci-cd/backend/ENVIRONMENTS_MATRIX.md` for the full secret/env mapping.
...
- `docs/tests/4-contract-tests/postman-newman/PLAN.md`
- `docs/tests/4-contract-tests/postman-newman/CHECKLIST.md`
