...
For project-wide strategy, see `docs/ci-cd/CI_CD_STRATEGY.md`.  
For environment details, see `docs/ci-cd/frontend/ENVIRONMENTS_MATRIX.md`.  
For job-by-job expectations, see `docs/ci-cd/frontend/GITHUB_ACTIONS_PIPELINE_PLAN.md` and `GITHUB_ACTIONS_PIPELINE_CHECKLIST.md`.
For BE-to-FE contract/deploy dependencies, see `docs/ci-cd/frontend/BACKEND_HANDOFF_FOR_FE_CICD.md`.
...
- Use `docs/ci-cd/frontend/BACKEND_HANDOFF_FOR_FE_CICD.md` as the shared release/dependency checklist between FE and BE.
...
- Frontend CI/CD plan and checklist:
  ...
  - `docs/ci-cd/frontend/GITHUB_ACTIONS_PIPELINE_CHECKLIST.md`
