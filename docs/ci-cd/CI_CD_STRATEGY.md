...
> Special Note for Codex: When asked “how is CI/CD structured for Lakira?” or when generating pipeline definitions, use this file as the root reference and then drill into the backend/frontend docs under `docs/ci-cd/backend/**` and `docs/ci-cd/frontend/**`.
...
(Details to be expanded in `docs/ci-cd/frontend/README.md`.)
...
- `docs/ci-cd/frontend/ENVIRONMENTS_MATRIX.md` (optional)
