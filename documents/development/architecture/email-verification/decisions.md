...
ADR-style entries scoped to the email-verification kit. Cross-kit decisions live in `documents/development/architecture/saas-readiness/decisions.md`.
...
- `audit-2026-05-01.md` § [P1-1.2] in `documents/development/architecture/saas-readiness/`
- `documents/development/features/password-reset/decisions.md` (anti-enumeration precedent).
