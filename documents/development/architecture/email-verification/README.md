...
- **Reference flow:** `documents/development/features/password-reset/` (gold-standard token-by-email kit).
...
- **Closes audit gaps:** [P1-1.2] in `documents/development/architecture/saas-readiness/audit-2026-05-01.md`.
- **Owning ADRs:** ADR-005 (phase order) in `documents/development/architecture/saas-readiness/decisions.md`; (kit-local) ADR-001 (24-hour TTL + anti-enumeration response shape) in `./decisions.md`.
- **Effort:** M.
- **Status:** Proposed.
