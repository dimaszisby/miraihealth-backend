...
- **Closes audit gaps:** [P0-5.1] (request-ID), [P1-5.2] (Sentry), [P1-5.3] (readiness probe), [P1-4.3] (Winston redaction) in `documents/development/architecture/saas-readiness/audit-2026-05-01.md`.
- **Owning ADRs:** ADR-005 (phase order) in `documents/development/architecture/saas-readiness/decisions.md`; (kit-local) ADR-001 (ALS vs cls-rtracer), ADR-002 (Sentry init lifecycle), ADR-003 (sensitive-keys module location) in `./decisions.md`.
