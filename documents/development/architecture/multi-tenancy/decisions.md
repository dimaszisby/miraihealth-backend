...
ADR-style entries scoped to the multi-tenancy kit. The cross-kit ADR-004 (the choice to introduce Organization + Membership at all) lives in `documents/development/architecture/saas-readiness/decisions.md` and gates this kit.
...
- `documents/development/features/password-reset/` (reference pattern).
