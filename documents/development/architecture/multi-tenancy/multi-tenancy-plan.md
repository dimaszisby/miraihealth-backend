...
1. ADR-004 in `documents/development/architecture/saas-readiness/decisions.md` flips Proposed → Accepted by the user. This kit's `decisions.md` ADRs (FK cascade, role enum location, invite-token format) are reviewed.
