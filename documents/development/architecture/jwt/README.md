...
- **Closes audit gaps:** [P0-1.1] (refresh tokens), [P1-10.3] (auth middleware leaks `jwt.verify`) in `documents/development/architecture/saas-readiness/audit-2026-05-01.md`.
