...
ADR-style entries scoped to the JWT kit. Cross-kit decisions live in `documents/development/architecture/saas-readiness/decisions.md` (e.g., ADR-005 phase order).
...
- `audit-2026-05-01.md` § [P0-1.1] in `documents/development/architecture/saas-readiness/`
...
- `audit-2026-05-01.md` § [P1-10.3] in `documents/development/architecture/saas-readiness/`
