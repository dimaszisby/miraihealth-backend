...
- `.claude/rules/documentation.md` → architecture docs belong in `documents/development/architecture/`
- `.claude/agents/doc-writer.md` → architecture docs belong in `documents/documentation/architecture/`
...
`SCHEMATHESIS_HOOKS=documents.tests.contract_hooks.seeded_ids` resolves through
