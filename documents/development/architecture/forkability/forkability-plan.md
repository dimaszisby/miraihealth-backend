...
1. **Create `CONTRIBUTING.md`** at the repo root covering:
   ...
   - Testing: link to `documents/tests/TESTING_STRATEGY.md`.
...
- `documents/development/architecture/saas-readiness/audit-2026-05-01.md` § 11.2–11.5
- `documents/development/architecture/saas-readiness/iteration-plan.md` — Phase 6
