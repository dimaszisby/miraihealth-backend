...
- [x] Create template README for every feature describing domain/application/infrastructure expectations. _(2025-12-02 — see `documents/development/features/README.md`)_
...
- [x] Update `documents/development/features/<feature>/README.md` once the slice is stable. _(2025-12-03 — auth README now documents controllers + testing strategy)_
