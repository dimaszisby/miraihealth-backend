...
- ✅ (2025-12-03) Documented the router factory pattern in `documents/development/features/README.md`; keep the template updated when new slices are added.
