...
- Gold review reports the disposition of *every* finding plus newly surfaced issues.
...
| --- | --- | --- | --- |
| `feature-vertical-slice-migration-in-depth-review.md` | Finding-level audit of every feature | Codex reviewer | `documents/development/architecture/feature-vertical-slice-migration/reviews/2025-12-07/…` |
...
- **Output:**
  - `documents/development/architecture/feature-vertical-slice-migration/reviews/2025-12-07/feature-vertical-slice-migration-in-depth-review.md`
- **Required structure:**
...
- **Output:**
  - `documents/development/architecture/feature-vertical-slice-migration/reviews/2025-12-07/feature-vertical-slice-migration-stabilize-feature-pattern-plan.md`
- **Required structure:**
...
- **Output:**
  - Either:
    - `documents/development/architecture/feature-vertical-slice-migration/reviews/2025-12-07/feature-vertical-slice-migration-gold-review.md`, or
