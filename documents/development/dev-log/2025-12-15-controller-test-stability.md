...
## Follow-ups
- Keep `documents/todos/` for scratch notes, but archive lasting findings (like this validation helper change) into `documents/development/dev-log/` to aid future debugging.
