...
- `documents/security/framework/ci-gate-policy.json` exists.
...
- New folder created: `documents/security/audit/audit-2026-03-01/`
...
```bash
npm run security:gate:evaluate -- --input tmp/security/security-delta-report.json --policy documents/security/framework/ci-gate-policy.json --output tmp/security/security-gate-result.json
```
...
- If truly temporary, use formal exception process from `documents/security/framework/security-exceptions-policy.md`.
...
- Junior framework overview: `documents/security/guides/security-framework-junior-guide.md`
- Framework lifecycle: `documents/security/framework/security-audit-framework.md`
- Master checklist: `documents/security/framework/security-audit-master-checklist.md`
