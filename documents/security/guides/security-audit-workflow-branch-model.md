...
- Record results in the active audit run folder under `documents/security/audit/`.
...
5. Update `documents/security/audit/index.md` status and highlights.
...
- `documents/security/framework/security-exceptions-policy.md`
- `documents/security/framework/ci-gate-policy.json`
- `documents/security/guides/security-release-delta-sop.md`
- `documents/ci-cd/CI_CD_DEVELOPER_SIMPLIFIED_GUIDE.md`
