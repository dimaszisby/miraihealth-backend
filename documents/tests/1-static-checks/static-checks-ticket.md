...
- Past guidance (`documents/tests/overhaul/test-structure-plan.md`) called out static checks as the next investment area post-overhaul.

## Acceptance Criteria

- README + plan + checklist published in `documents/tests/1-static-checks/` describing commands, scope, and milestones.
...
- Dependent docs: `documents/tests/overhaul/`, `documents/ci-cd/backend/**`.
