...
- **Scope:** Deliver the end-to-end static-check experience promised in `documents/tests/overhaul/`, covering lint, typecheck, formatting, OpenAPI drift detection, and pre-commit automation.
