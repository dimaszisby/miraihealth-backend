...
- `documents/tests/4-contract-tests/postman-newman/environments/lakira-local.postman_environment.json`
- `documents/tests/4-contract-tests/postman-newman/environments/lakira-staging.postman_environment.json`
...
3. Copy values into `documents/tests/4-contract-tests/postman-newman/environments/lakira-local.postman_environment.json`.
