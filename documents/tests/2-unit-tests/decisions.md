...
- **References:** `jest.config.mjs`, `jest.setup.unit.ts`, `package.json` scripts, `documents/tests/2-unit-tests/README.md`.
...
- **References:** `__tests__/unit/factories/metric-settings.ts`, `documents/tests/2-unit-tests/README.md`, `WORKFLOW_GUIDELINES.md`.
...
- **References:** `jest.config.mjs`, `package.json` (jest-junit dependency), `documents/tests/2-unit-tests/README.md`, `documents/tests/2-unit-tests/WORKFLOW_GUIDELINES.md`, `documents/ci-cd/CI_CD_DEVELOPER_SIMPLIFIED_GUIDE.md`.
