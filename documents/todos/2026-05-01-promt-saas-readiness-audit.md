...
- The structure of `documents/security/` (existing security audit infrastructure)
...
Per `.claude/rules/documentation.md`, architectural topics live under `documents/development/architecture/<topic>/` as a lean kit. Use:

```
documents/development/architecture/saas-readiness/
...
- Do NOT compact or reformat anything under `documents/security/audit/` (schema-validated by tests).
