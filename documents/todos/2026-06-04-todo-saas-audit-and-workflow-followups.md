...
- [ ] **SaaS-readiness re-audit** of `documents/development/architecture/saas-readiness/` against current source code
  - **Model:** Opus
  ...
  - **Outputs:**
    - New `documents/development/architecture/saas-readiness/audit-2026-06-04.md`
