...
function generateDocumentation() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    // Recursively read files from the types directory
    function readTypesDirectory(dirPath) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [4 /*yield*/, readTypesDirectory(filePath)];
            case 2:
              _a.sent(); // Recursive call for directories
              return [3 /*break*/, 5];
            case 3:
              if (!(stat.isFile() && file.endsWith(".ts")))
                return [3 /*break*/, 5];
              return [4 /*yield*/, processTypeFile(filePath)];
            case 4:
              _a.sent(); // Process .ts files
              _a.label = 5;
            case 5:
              _i++;
              return [3 /*break*/, 1];
    ...
    // Read all type files
    yield readTypesDirectory(typesDir);
