...
**Rule**: Never reformat, condense, or restructure files under `docs/internal/audits/security/`. Their column names, section headers, and table structure are enforced by automated tests.
