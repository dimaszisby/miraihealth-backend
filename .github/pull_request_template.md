...
- [ ] Updated security audit artifacts when required (`docs/internal/audits/security/**`)
- [ ] For production release PRs: followed `docs/how-to/security/release-delta-sop.md`
